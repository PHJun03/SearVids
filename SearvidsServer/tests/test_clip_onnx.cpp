...
static const fs::path TEXT_MODEL  = "../../onnx/onnx_models/simplified/clip_text_sim.onnx";
static const fs::path VISION_MODEL = "../../onnx/onnx_models/simplified/clip_vision_sim.onnx";
